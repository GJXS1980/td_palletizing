...
class TA_Vision():
    def __init__(self):
        ...
        self.x_dis = rospy.get_param("~x_dis", 5.0) # x方向补偿,mm
        self.y_dis = rospy.get_param("~y_dis", 10.0) # y方向补偿,mm
        self.z_dis = rospy.get_param("~z_dis", -35.0) # z方向补偿,mm
    ...
    def get_ar_pose(self, msg):
        ...
        if self.TA_Vision_Mqtt.TD_Vision_ID == 1 and self.ar_pose_array[7][2] != 0.0:
            ...
            target_pose =[self.ta_current_x+self.ar_pose_array[7][0]+self.x_dis, self.ta_current_y+self.y_dis-self.ar_pose_array[7][1], self.ta_current_z+self.ar_pose_array[7][2]+self.z_dis]
        ...
        if self.TA_Vision_Mqtt.TD_Vision_ID == 2 and self.ar_pose_array[1][2] != 0.0:
            self.TA_Vision_Mqtt.TD_Vision_ID = 0
            self.ta_vision_req_msg["action"] = self.TA_Vision_Mqtt.TD_Vision_Type
            target_pose =[self.ta_current_x+self.ar_pose_array[1][0]+self.x_dis, self.ta_current_y+self.y_dis-self.ar_pose_array[1][1], self.ta_current_z+self.ar_pose_array[1][2]+self.z_dis]
        ...
        if self.TA_Vision_Mqtt.TD_Vision_ID == 3 and self.ar_pose_array[2][2] != 0.0:
            self.TA_Vision_Mqtt.TD_Vision_ID = 0
            self.ta_vision_req_msg["action"] = self.TA_Vision_Mqtt.TD_Vision_Type
            target_pose =[self.ta_current_x+self.ar_pose_array[2][0]+self.x_dis, self.ta_current_y+self.y_dis-self.ar_pose_array[2][1], self.ta_current_z+self.ar_pose_array[2][2]+self.z_dis]
        ...
        if self.vision_mode == 1 and self.ar_pose_array[6][2] != 0.0 and self.push_state == 1:
            target_pose =[self.ta_current_x+self.ar_pose_array[6][0]+self.x_dis, self.ta_current_y+self.y_dis-self.ar_pose_array[6][1], self.ta_current_z+self.ar_pose_array[6][2]+z_dis]
